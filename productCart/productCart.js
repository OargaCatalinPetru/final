...
function stopLoading(){
  ...
  comprarBtnElement.innerHTML='Checkout'
...
function createCart(data){
  ...
  cartContainer.innerHTML=`
    ...
    <div class='cart_price'>$ ${(data.descuento ? data.price * 0.8 : data.price) * data.quantity}</div>
...
function getCartDetail(){  
    cartDetailQuantity.innerHTML=`Quantity: ${getCartTotalQuantity(cartStorage)}`
